...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	// create new user
	$stmt = $pdo->prepare('INSERT INTO users (username, email, password, name, surname, personalid, role, activated) VALUES (?, ?, ?, ?,?,?, ?, 1)');
	$stmt->execute([$username, $email, $pwd1, $name, $surname, $personalid, "user"]);
